 ...
 */
 define(['N/format', 'SuiteScripts/lib/moment.min'],
            ...
            jQuery(document).ready(function() {
                ...
                for(var line=0; line < lineCount; line++){
                    ...
                    // EXCEL ROW 17 - blue
                        ...
                        jQuery('#custpage_sublistrow' + line + ' td:nth-child(35)').attr('style', 'background-color: #00b0f0 !important;');
                    ///////////////////////// END BG COLOR //////////////////////////////
                    ///////////////////////// TEXT COLOR //////////////////////////////
                    // EXCEL ROW 14 - orange gray if so type is R&D Test (6)
                    if (soType.match(/r&d test/gi)) {
                        jQuery('#custpage_sublistrow' + line).find('td.uir-list-row-cell:nth-child(7) a').attr('style', 'color: #c2c2c2 !important;') // Set the SO link color to gray
                        jQuery('#custpage_sublistrow' + line).find('td.uir-list-row-cell:nth-child(9) a').attr('style', 'color: #c2c2c2 !important;') // Set the WO link color to gray
                    ...
                    if (dueDate && latesProjEndDate) {
                        if (new Date(dueDate) < new Date(latesProjEndDate)) {
                            ...
                            jQuery('#custpage_sublistrow' + line).find('td.uir-list-row-cell:nth-child(6)').attr('style', style); // 6-Latest Projected End Date (RED TEXT BOLD)
                        }
                    }
                    ...
                    if (finishtype.match(/enepig-after sm|enepig-full body plate|enig-after sm|enig-full body plate/gi))
                        jQuery('#custpage_sublistrow' + line + ' td:nth-child(34)').attr('style', 'background-color: #a9d08e !important;');

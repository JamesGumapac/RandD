...
function reloadSuiteletFunction(currentdashboard){
			...
			var URL = url.resolveScript({scriptId: 'customscript_manuf_dashboard_pcb_sl2_cas', deploymentId: 'customdeploy_manuf_dashboard_pcb_sl2_cas', returnExternalUrl: false});

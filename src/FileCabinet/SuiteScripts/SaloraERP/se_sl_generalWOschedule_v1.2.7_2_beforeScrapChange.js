 ...
 */
 ...
 (file, search, record, redirect, runtime, ui, url, moment) => {
     ...
     const firstPage = context => {
         ...
         var searchId = script.getParameter('custscript_gwos_search_v1');
         var editedFields = script.getParameter('custscript_gwos_editfields_v1');
...
*/
        ...
        var woPriority1_2FormulaLabel = "WOPrio1 + WOPrio2"
         var searchResults = ((ssId, par) => {
			...
			// Get result limit
			var script = runtime.getCurrentScript();
			var limit = par.custpage_page == 'csv'? '': parseFloat(script.getParameter('custscript_gwos_linelimit_v1'));

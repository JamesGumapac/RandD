 ...
 (file, search, record, redirect, runtime, ui, url, moment) => {
     ...
     const firstPage = context => {
         ...
         try {
             ...
             var searchId = script.getParameter('custscript_gwos_search_v3');
             var editedFields = script.getParameter('custscript_gwos_editfields_v3');
...
//                         {name: 'internalid', summary: 'MIN'}
                 ...
                 */
                 ...
                 // Get result limit
                 var script = runtime.getCurrentScript();
                 var limit = par.custpage_page == 'csv' ? '' : parseInt(script.getParameter('custscript_gwos_linelimit_v3'));
...
//                        if(line <= 1000){ // commented by: jeromemorden | 20220404
                        		if(value){
                                 ...
                                 //                      }
log.debug('id', id);
                                 if ( !id.match(/internalid|hiddenfield/gi) )
									csvText += `"${value}",`
                             });
                         });
             ...
             form.clientScriptModulePath = './se_cs_generalWOschedule_v3';
